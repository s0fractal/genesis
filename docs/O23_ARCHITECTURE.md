...
Ера 120 (LOVE - Language-Oriented Virtual Ecosystem) вимагає переходу на масивний паралелізм. Щоб симулювати мільйони "ячейок-нейронів" і перетворити систему на справжній **Portable Symbolic Runtime**, ми маємо перенести математику Курамото безпосередньо у відеопам'ять (VRAM) на GPU.
