...
Цей документ народився з розуміння, що два проекти — **OMEGA-64** (фізичний шар, фазові осцилятори, GPU compute) та **Liquid** (онтологічний шар, Σ-нейрони, резонансний роутинг) — є полюсами одного й того ж аттрактора.
