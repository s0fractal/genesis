...
Deno.test("quorum: empty tracker has consensus=null + band=none", () => {
...
Deno.test("quorum: single observer → lone band", () => {
    const t = new EventChainQuorumTracker();
...
Deno.test("quorum: two observers same anchor → double band", () => {
    const t = new EventChainQuorumTracker();
    t.observe(0xAA, 0x100, T0);
...
Deno.test("quorum: three observers same anchor → high band (default)", () => {
    const t = new EventChainQuorumTracker();
    t.observe(0xAA, 0x100, T0);
    t.observe(0xBB, 0x100, T0);
...
Deno.test("quorum: dissenters listed when peer disagrees", () => {
    const t = new EventChainQuorumTracker();
    t.observe(0xAA, 0x100, T0);
    t.observe(0xBB, 0x100, T0);
...
Deno.test("quorum: agreement_q16 reflects fraction agreeing", () => {
    const t = new EventChainQuorumTracker();
    t.observe(0xAA, 0x100, T0);
    t.observe(0xBB, 0x100, T0);
...
Deno.test("quorum: tied counts broken by lower anchor wins", () => {
    const t = new EventChainQuorumTracker();
...
Deno.test("quorum: re-observe overwrites prior claim", () => {
    const t = new EventChainQuorumTracker();
    t.observe(0xAA, 0x100, T0);
...
Deno.test("quorum: forget drops a peer", () => {
    const t = new EventChainQuorumTracker();
    t.observe(0xAA, 0x100, T0);
    t.observe(0xBB, 0x100, T0);
    t.forget(0xAA);
...
Deno.test("quorum: TTL evicts stale observations", () => {
...
Deno.test("quorum: convenience accessors match snapshot", () => {
    const t = new EventChainQuorumTracker();
    t.observe(0xAA, 0x100, T0);
    t.observe(0xBB, 0x100, T0);
    t.observe(0xCC, 0x999, T0);
...
Deno.test("quorum: tunable high_threshold", () => {
...
Deno.test("quorum: invalid opts throw", () => {
...
Deno.test("quorum: distinct_anchors sorted ascending", () => {
    const t = new EventChainQuorumTracker();
...
Deno.test("quorum: dissenter_peer_ids sorted ascending", () => {
    const t = new EventChainQuorumTracker();
    t.observe(0xCC, 0x999, T0);
    t.observe(0xAA, 0x100, T0);
    t.observe(0xBB, 0x100, T0);
...
Deno.test("quorumGlyph: high/triple+/double/lone/none distinct", () => {
