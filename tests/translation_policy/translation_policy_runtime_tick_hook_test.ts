...
} from "../../src/bootstrap/translation_policy/translation_policy_runtime_tick_hook.ts";
import { TranslationPolicyRuntimeTickResult } from "../../src/network/translation_policy/translation_policy_runtime.ts";
