...
const kura = await Deno.readTextFile(new URL("../src/lens/shaders/compute_kuramoto.wgsl", import.meta.url));
const myc = await Deno.readTextFile(new URL("../src/lens/shaders/compute_mycelial.wgsl", import.meta.url));
