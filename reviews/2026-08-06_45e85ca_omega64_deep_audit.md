...
| L5 замкнений баланс — `tick_physics`     | відкрито    | хижацтво, кламп `MAX_ATP`, хвостові агенти      |
| L6 SubstrateCourt                        | відкрито    | залежить від рамки consensus/perspectival       |
| L7 вага oracle-голосу в peer-талі        | відкрито    | змінює семантику врядування                     |
| L11 прообраз warrant                     | відкрито    | patch чи чесний demote до `advisory`            |
