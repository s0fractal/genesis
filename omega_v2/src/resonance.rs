//! Resonance Tensor (EpicyclicSoul)
//! Computes global Kuramoto order parameter and per-agent resonance scores.
//! All math is integer-only (Q10 fixed-point), deterministic across platforms.
//!
//! # Φ-Маніфест
//! Liquid sees OMEGA as a Σ-neuron with enormous ρ. The ResonanceField
//! is the "activation vector" of that neuron — global sync (r) and phase (Ψ).
