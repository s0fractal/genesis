...
fn test_golden_vectors_phi_bridge() {
    ...
    assert!(t.get_cos(phi3) < -1040000, "cos(180) should be near -1048576");
    ...
    assert_eq!(shortest, 20, "Golden Vector Distance must be exactly 20 across the wraparound boundary");
