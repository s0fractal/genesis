...
use omega_v2::genesis_inscription::{compute_genesis_hash, GenesisAnchors, GENESIS_HASH_V1_0};
...
fn main() {
    ...
    println!("GENESIS_HASH_V1_0           = 0x{:08x}", g);
    all_ok &= g == GENESIS_HASH_V1_0 && g == 0x549A_6307;
