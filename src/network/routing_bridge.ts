...
export interface WasmExports {
  ...
  v2_route_hyperbolic_distance?: (
    a_raw: number,
    a_ortho: number,
    b_raw: number,
    b_ortho: number,
  ) => number;
  v2_route_hyperbolic_distance_toroidal?: (
    a_raw: number,
    a_ortho: number,
    b_raw: number,
    b_ortho: number,
  ) => number;
  v2_route_hyperbolic_distance_3d?: (
    a_raw: number,
    a_ortho: number,
    tau_a: number,
    b_raw: number,
  ...
  v2_route_taylor_step_curvature_raw?: (
    src_raw: number,
    src_ortho: number,
    dst_raw: number,
    dst_ortho: number,
  ...
  v2_route_taylor_step_curvature_ortho?: (
    src_raw: number,
    src_ortho: number,
    dst_raw: number,
    dst_ortho: number,
...
export class PhaseRouter {
   ...
   */
  static hyperbolicDistanceToroidalStatic(
    a: PhaseAddress,
    b: PhaseAddress,
  ): number {
    const da = PhaseRouter.decode(a);
