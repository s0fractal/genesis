// VENDORED from trinity probes/receipt-envelope-encoder-v0/ts/envelope.ts
// (see canonical_cbor.ts header). omega imports `wrap` from here to emit its own
// substrate_tag:omega witness. Parity-guarded from trinity.
