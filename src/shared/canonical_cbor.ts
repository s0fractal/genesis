// VENDORED from trinity probes/receipt-envelope-encoder-v0/ts/canonical_cbor.ts
// so omega can sign its own ReceiptEnvelope without a cross-repo runtime
// dependency (substrate sovereignty: each substrate owns its encoding). Held
// byte-functionally identical to the source by a parity test in trinity
// (probes/receipt-envelope-encoder-v0/ts/vendor_parity_test.ts). Do not edit
// here without updating the source and re-checking parity.
